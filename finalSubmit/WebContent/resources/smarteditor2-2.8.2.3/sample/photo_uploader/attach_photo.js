	...
	function onAjaxError (e){
		alert("[가이드]사진 업로더할 서버URL셋팅이 필요합니다.-onAjaxErrorr"+e._response.responseText);
	}
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/noticeWriteDo',	//샘플 URL입니다.
 	        sCallback : 'smarteditor2/sample/photo_uploarder/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
