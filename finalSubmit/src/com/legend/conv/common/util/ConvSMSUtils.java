...
import org.json.simple.JSONObject;
	...
	public class ConvSMSUtils {
		...
		public void send_msg(String tel, String rand) {
	        ...
	        // 개인 인증키
	        String accessKey = "EU4IQDAArbeaBcdH8LEf";
	        // 2차 인증을 위해 서비스마다 할당되는 service secret
	        String secretKey = "cKDR3b5LLZ9dLCsbp3yvATxsi7veDCjIz1Or6p7p";
	        // 프로젝트에 할당된 SMS 서비스 ID
	        String serviceId = "ncp:sms:kr:313106954699:conv";
	        // 요청 method
	        String method = "POST";
