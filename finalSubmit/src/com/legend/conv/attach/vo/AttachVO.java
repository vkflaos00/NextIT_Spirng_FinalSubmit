package com.legend.conv.attach.vo;
...
public class AttachVO {
	...
	private String atchAuthor;               /* 등록자 */
	
	
	public AttachVO() {}


	public AttachVO(int atchNo, String atchParentNo, String atchCategory, String atchFileName, String atchOriginalName,
			long atchFileSize, String atchConvertSize, String atchContentType, String atchPath, int atchDownHit,
			String atchDelYn, String atchAuthor) {
		super();
		this.atchNo = atchNo;
	...
	public String getAtchAuthor() {
		return atchAuthor;
	}


	public void setAtchAuthor(String atchAuthor) {
		this.atchAuthor = atchAuthor;
	}
